...
*/
    ...
    // APP DIRECTORY ROOT FOR WEB ROOT FILES (for href and src html )
    const WEBROOT = '/app/';
...
<nav>
    ...
    <a href="<?=WEBROOT?>app-servicios/">App Servicios</a>
    <a href="<?=WEBROOT?>app-about/&x=3">app About</a>
    <a href="<?=WEBROOT?>no-exist-page/">No existente</a>
</nav>
